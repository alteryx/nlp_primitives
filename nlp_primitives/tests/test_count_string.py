...
class TestCountString(PrimitiveT):
    ...
    def test_non_regex_with_no_other_parameters(self):
        primitive = self.primitive("hello", ignore_case=False,
    ...
    def test_non_regex_ignore_case(self):
        primitive1 = self.primitive("hello", ignore_case=True,
                                    ignore_non_alphanumeric=False,
                                    is_regex=False,
                                    match_whole_words_only=False)

        primitive2 = self.primitive("HeLLo", ignore_case=True,
                                    ignore_non_alphanumeric=False,
                                    is_regex=False,
                                    match_whole_words_only=False)
    ...
    def test_non_regex_with_all_others_parameters(self):
        primitive = self.primitive("hello", ignore_case=True,
                                   ignore_non_alphanumeric=True,
                                   is_regex=False,
                                   match_whole_words_only=True)
    ...
    def test_regex_with_no_other_parameters(self):
        primitive = self.primitive("h.l.o", ignore_case=False,
                                   ignore_non_alphanumeric=False,
                                   is_regex=True,
                                   match_whole_words_only=False)
    ...
    def test_regex_with_ignore_case(self):
        primitive = self.primitive("h.l.o", ignore_case=True,
                                   ignore_non_alphanumeric=False,
                                   is_regex=True,
                                   match_whole_words_only=False)
    ...
    def test_overlapping_regex(self):
        primitive = self.primitive("(?=(a.*a))", ignore_case=True,
                                   ignore_non_alphanumeric=True,
                                   is_regex=True,
                                   match_whole_words_only=False)
        test_cases = pd.Series([
    ...
    def test_the(self):
        primitive = self.primitive("the", ignore_case=True,
                                   ignore_non_alphanumeric=False,
                                   is_regex=False,
                                   match_whole_words_only=False)
        test_cases = pd.Series([
    ...
    def test_with_featuretools(self, es):
        ...
        primitive_instantiate = self.primitive("the", ignore_case=True,
                                               ignore_non_alphanumeric=False,
                                               is_regex=False,
                                               match_whole_words_only=False)
